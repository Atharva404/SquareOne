        ...
        NavigationView {
            ZStack {
                ...
                ScrollView{
                    ...
                    LazyVStack(alignment: .trailing, spacing: 15, content: {
                        ForEach(self.viewModel.meetings, id: \.self){ meeting in
                            MeetingCard(title: meeting.name, description: meeting.description, time: meeting.time, alert: true)
                        }
                        Spacer()
                    }).padding(.top)
                }
